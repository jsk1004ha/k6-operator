...
const (
	...
	// SetupExecuted indicates whether the `setup()` execution has been claimed.
	// It is persisted before invoking `setup()` to prevent duplicate execution during reconciliation.
